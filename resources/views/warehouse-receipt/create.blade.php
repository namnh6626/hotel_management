...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Tạo hóa đơn kho hàng</h1>
            </div>
        ...
        <form action="{{ route('warehouse-receipt.store')}}" method="POST">
                    ...
                    <table style="border-top: 1px solid black" class="display cell-border" id="bill-info">
                        ...
                        <tbody >
                            ...
                            <tr >
                                ...
                                <td>
                                    <select class="form-select" name="receipt_type" id="">
            ...
            <div class="row py-3">
                ...
                <div class="col d-flex">
                    <button type="submit" style="margin: 0 auto" class="btn btn-primary ">Thêm mới hóa đơn</button>
                </div>
                <div class="col"></div>
            </div>
        </form>
