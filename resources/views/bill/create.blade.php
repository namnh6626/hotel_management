...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Nhận phòng</h1>
            </div>

        </div>
        <div class="row">
            <div class="col">
                <a class="btn btn-sm btn-primary" href="{{ route('room.index') }}">Sơ đồ phòng</a>
            </div>
        ...
        <form action="{{ route('bill.store')}}" method="POST">
            ...
            <div class="row py-3">
                ...
                <div class="col d-flex">
                    <button type="submit" style="margin: 0 auto" class="btn btn-primary ">Nhận phòng</button>
                </div>
                <div class="col"></div>
            </div>
        </form>
