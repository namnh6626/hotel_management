...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Cập nhật thông tin quỹ</h1>
            </div>
        ...
        <form action="{{ route('budget.update', $budget->budget_id) }}" method="POST">
            ...
            <div class="container-fluid">
                ...
                <div class="row py-3 align-items-center">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control " value="{{ $budget->budget_name }}" type="text" name="name" required/>
                    </div>
                ...
                <div class="row py-3 align-items-center">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" id="amount" value="{{ number_format( $budget->amount) }}" name="amount" onkeyup="formatToMoney('amount')" required/>
