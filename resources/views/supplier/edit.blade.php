        ...
        <form action="{{ route('supplier.store') }}" method="POST">
            ...
            <div class="container-fluid">
                ...
                <div class="row py-3 align-items-center">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control " type="text" value="{{ $supplier->supplier_name }}" name="name" required />
                    </div>
                ...
                <div class="row py-3 align-items-center">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control " type="tel" value="{{ $supplier->supplier_phone }}" name="phone" required />
                    </div>
                ...
                <div class="row py-3 align-items-center">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control " type="text" value="{{ $supplier->supplier_address }}" name="address" required />
                    </div>
